    ...
    products.forEach(p => {
      ...
      <div class="col-sm-6 col-md-4 col-lg-3 mb-4">
        <div class="store-card">
          <a href="single_product.php?id=${p.product_id}" class="img-link"><img src="${img}" alt="${escapeHtml(p.product_title)}" class="store-img"></a>
          <div class="store-body">
            <div class="store-meta"><small class="text-muted">${escapeHtml(p.brand_name || '')} • ${escapeHtml(p.cat_name || '')}</small></div>
            <h5 class="store-title"><a href="single_product.php?id=${p.product_id}">${escapeHtml(p.product_title)}</a></h5>
            ...
            <div class="d-flex justify-content-between mt-2">
              ...
              <a href="single_product.php?id=${p.product_id}" class="btn btn-sm btn-primary">View</a>
            </div>
          </div>
        </div>
      </div>`;
